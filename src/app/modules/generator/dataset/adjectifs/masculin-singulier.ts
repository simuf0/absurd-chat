const adjectifs = [
  ...
  "touchant",
  "touché par la grâce",
  "touché par un mouvement de grève",
  "toueur",
  "touffu",
  "toujours jeune",
  "toulousain",
